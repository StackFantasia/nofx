...
func (at *AutoTrader) recordAndConfirmOrder(orderResult map[string]any, symbol, action string, quantity float64, price float64, leverage int, entryPrice float64) {
	if at.store == nil {
		return
	}
